...
(function () {
    ...
    class ChronoChatApp {
        constructor() {
            ...
            this.aiPersonaSelectorContainer = document.getElementById('ai-persona-selector-container');
            ...
            this.snapshotLoadingIndicator = document.getElementById('snapshot-loading-indicator');
            ...
            try {
                ...
                switch (this.activeChatContext.type) {
                    ...
                    case 'dm-mock':
                        ...
                        if (!mockParticipant)
                            throw new Error("Mock participant not found for DM.");
